...
definition(
		...
		author: "SmartThings",
		description: "Connect your Wiser Air thermostat to SmartThings.",
...
preferences {
	page(name: "auth", title: "Wiser Air", nextPage:"", content:"authPage", uninstall: true, install:false)
	page(name: "deviceList", title: "WiserAir", content:"DeviceList", install:true)
}
...
def authPage() {
	...
	if(state.authToken) {
		...
		description = "Click to enter Wiser Credentials"
	}
